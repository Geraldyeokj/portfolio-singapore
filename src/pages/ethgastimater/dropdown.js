...
const Dropdown = () => {
    ...
    return (
        <div className='m-auto w-full md:w-3/4'>
            <div className='col-span-2 text-4xl text-center pt-10 pb-3'>
                            ...
                            items={[
                                ...
                                <div className='grid grid-cols-2'>
                                    ...
                                    <div className='col-span-1 text-center'>
                                        <img className='rounded-lg overflow-hidden' src={aperiod}></img>
                                    </div>
                                </div>,
                                },
                            ]}
                        ...
                        <Collapse
                            ...
                            items={[
                                ...
                                <div className='grid grid-cols-2'>
                                    ...
                                    <div className='col-span-1 text-center'>
                                        <img className='rounded-lg overflow-hidden' src={freshfromtheoven}></img>
                                    </div>
                                </div>,
                                },
                            ]}
